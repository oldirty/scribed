...
class MicrophoneInput:
    ...
    def __init__(self, config: dict) -> None:
        ...
        self.logger.info(f"Microphone input configured - Rate: {self.sample_rate}Hz, Channels: {self.channels}")
...
class AsyncMicrophoneInput:
    ...
    async def start_recording(self, callback: Optional[Callable[[bytes], None]] = None) -> None:
