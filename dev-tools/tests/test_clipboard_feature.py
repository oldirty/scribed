    ...
    if is_clipboard_available():
        ...
        if set_clipboard_text(test_text):
            ...
            if retrieved_text == test_text:
                ...
                print(
                    f"❌ Retrieved text doesn't match: '{retrieved_text}' vs '{test_text}'"
                )
                return False
        else:
...
def test_api_endpoint():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(
                "⚠️  This will record audio for 2 seconds - make sure your microphone is working"
            )
